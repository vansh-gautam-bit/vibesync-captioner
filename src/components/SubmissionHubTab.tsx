...
export default function SubmissionHubTab() {
  ...
  const [formData, setFormData] = useState<SubmissionData>({
    ...
    videoPresentationUrl: "https://www.youtube.com/watch?v=demo",
    slidePresentationUrl: "https://docs.google.com/presentation/demo",
    githubUrl: "https://github.com/vansh-pku/vibesync-captioner",
    demoPlatform: "Google Cloud Run",
    appUrl: "https://vibesync-captioner.run.app",
