...
export default function SubmissionHubTab() {
  ...
  const [formData, setFormData] = useState<SubmissionData>({
    ...
    coverImageUrl: "https://drive.google.com/file/d/1gZgKdKIbqe9QTX52mp2ulPE62n8Wzyop/view?usp=drivesdk",
    videoPresentationUrl: "https://youtu.be/ZAXLcrMkfUA",
    slidePresentationUrl: "https://drive.google.com/file/d/1OmDCNuAi9HnuXytqiOq_AV45b974h4vN/view?usp=drivesdk",
    githubUrl: "https://github.com/vansh-gautam-bit/vibesync-captioner",
    demoPlatform: "Google Cloud Run",
    appUrl: "https://video-captioning-playground-submission-hub.ai.studio",
